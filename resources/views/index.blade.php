...
<main>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="./image/slider1.JPG" width="1349px" height="500px">
...
<div class="mb-3 mt-3 text-center">
  <div class="row g-0">
    <div class="card text-bg-dark" style="border: 0;">
     <img src="./image/desktop-wallpaper-ayatollah-khamenei-meets-with-officials-of-iran-s-hajj-ali-khamenei-thumbnail.jpg" style="margin: auto;">
     <div class="card-img-overlay">
      <h5 class="card-title text-white">آن مجموعه ای که برای اشتغال </h5>
      <h5 class="card-title text-white">در کشور کار کار می کند،</h5>
      <h5 class="card-title text-white">باید مثل اتاق جنگ دوران مقدس</h5>
      <h5 class="card-title text-white">که شب و روز نمی شناخت، کار کند. </h5>
    </div>
    </div>
  </div>
</div>
      ...
      <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        <div class="col">
          <div class="card h-100">
            <img src="{{ $organ->image }}" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">{{ $organ->master }}</h5>
...
<div class="my-5">
  ...
  <footer class="text-center text-lg-start text-white" style="background-color: rgb(4, 44, 163)">
    ...
    <div class="container p-4 pb-0">
      ...
      <section class="">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p>
              شرکت کار و اندیشه ماهر توانا شرکتی است که برای شما دوستان عزیز ایجاد شغل و کسب و کار دارد و پذیرای شما
              عزیزان است
            </p>
          </div>
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
            ...
            <p>
              <a class="text-white" href="aboutus.html">درباره ما</a>
            </p>
            <p>
              <a class="text-white" href="#">اخبار</a>
            </p>
            <p>
              <a class="text-white" href="#">لیست مدیران</a>
            </p>
            <p>
              <a class="text-white">لیست استاد ها</a>
            </p>
          </div>
          ...
          <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
            <h6 class="text-uppercase mb-4 font-weight-bold">ارتباط با ما</h6>
            <p><i class="fas fa-home mr-3"></i>مازندران,ساری,انتهای خیابان شمشیربند,روبروی پارک دانشجو,دانشگاه محمد
              باقر,مرکز رشد,طبقه2</p>
            <p><i class="fas fa-envelope mr-3"></i> hajtaha@gmail.com</p>
            <p><i class="fas fa-phone mr-3"></i>09114129576</p>
            <p><i class="fas fa-print mr-3"></i>09214247039</p>
          </div>



          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
            <h6 class="text-uppercase mb-4 font-weight-bold">ما را در صفحات مجازی دنبال کنید</h6>


            <a class="btn btn-primary btn-floating m-1" style="background-color: #06e3f3" href="#!" role="button"><i
                class="fab fa-telegram" href="https://t.me/busniness_coaching"></i></a>


            <a class="btn btn-primary btn-floating m-1" style="background-color: #f31c00" href="#!" role="button"><i
                class="fab fa-google"></i></a>

            <a class="btn btn-primary btn-floating m-1" style="background-color: #cf89de" href="#!" role="button"><i
                class="fab fa-instagram"></i></a>


            <a class="btn btn-primary btn-floating m-1" style="background-color: #007e04" href="#!" role="button"><i
      ...
      <div class="text-center p-3" style="background-color: rgb(4, 44, 163)">
        طراح سایت:طاها یحیی پور
        <br>
        شماره تلفن:09017530774
        <br>
        <a class="text-white" href="https://mdbootstrap.com/">ایمیل:tahayahyapour@gmail.com</a>
      </div>
